...
typedef void gen_helper_gvec_mem_scatter(TCGv_env, TCGv_ptr, TCGv_ptr, TCGv_ptr, TCGv_i64, TCGv_i32);
...
static bool gen_gvec_fpst_zz(DisasContext *s, gen_helper_gvec_2_ptr *fn, int rd, int rn, int data, ARMFPStatusFlavour flavour)
{
    if(fn == NULL) {
        return false;
    }
...
static bool gen_gvec_fpst_arg_zz(DisasContext *s, gen_helper_gvec_2_ptr *fn, arg_rr_esz *a, int data)
{
    return gen_gvec_fpst_zz(s, fn, a->rd, a->rn, data, a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR);
}
...
static bool gen_gvec_ool_zzz(DisasContext *s, gen_helper_gvec_3 *fn, int rd, int rn, int rm, int data)
{
    ...
    if(sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_3_ool(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vec_full_reg_offset(s, rm), vsz, vsz, data,
                           fn);
    }
    return true;
}
                              ...
                              ARMFPStatusFlavour flavour)
{
    ...
    if(sve_access_check(s)) {
        ...
        tcg_gen_gvec_3_ptr(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vec_full_reg_offset(s, rm), status, vsz, vsz,
                           data, fn);
...
{
    return gen_gvec_fpst_zzz(s, fn, a->rd, a->rn, a->rm, data, a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR);
}
...
static bool gen_gvec_ptr_zzzz(DisasContext *s, gen_helper_gvec_4_ptr *fn, int rd, int rn, int rm, int ra, int data, TCGv_ptr ptr)
{
    if(fn == NULL) {
        return false;
    }
...
static bool gen_gvec_fpst_zzzzp(DisasContext *s, gen_helper_gvec_5_ptr *fn, int rd, int rn, int rm, int ra, int pg, int data,
                                ARMFPStatusFlavour flavour)
{
    if(fn == NULL) {
        return false;
...
static bool gen_gvec_ool_zzp(DisasContext *s, gen_helper_gvec_3 *fn, int rd, int rn, int pg, int data)
{
    ...
    if(sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_3_ool(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), pred_full_reg_offset(s, pg), vsz, vsz, data,
                           fn);
    }
    return true;
}
                              ...
                              ARMFPStatusFlavour flavour)
{
    ...
    if(sve_access_check(s)) {
        ...
        tcg_gen_gvec_3_ptr(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), pred_full_reg_offset(s, pg), status, vsz, vsz,
                           data, fn);
        tcg_temp_free_ptr(status);
    }
    return true;
...
{
    return gen_gvec_fpst_zzzp(s, fn, a->rd, a->rn, a->rm, a->pg, 0, a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR);
}
...
__attribute__((unused)) static void gen_xar8_i64(TCGv_i64 d, TCGv_i64 n, TCGv_i64 m, int64_t sh)
{
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_xar16_i64(TCGv_i64 d, TCGv_i64 n, TCGv_i64 m, int64_t sh)
{
    TCGv_i64 t = tcg_temp_new_i64();
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_xar_i32(TCGv_i32 d, TCGv_i32 n, TCGv_i32 m, int32_t sh)
{
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_xar_i64(TCGv_i64 d, TCGv_i64 n, TCGv_i64 m, int64_t sh)
{
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_xar_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m, int64_t sh)
{
...
static bool trans_XAR(DisasContext *s, arg_rrri_esz *a)
{
    ...
    if(sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        gen_gvec_xar(a->esz, vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), vec_full_reg_offset(s, a->rm), a->imm,
                     vsz, vsz);
    }
    return true;
}
...
static void gen_eor3(unsigned vece, uint32_t d, uint32_t n, uint32_t m, uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
...
static void gen_bcax(unsigned vece, uint32_t d, uint32_t n, uint32_t m, uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
    static const GVecGen4 op = {
        .fni8 = gen_bcax_i64,
        .fniv = gen_bcax_vec,
...
{
    static gen_helper_gvec_4 *const fns[4] = { gen_helper_sve_sel_zpzz_b, gen_helper_sve_sel_zpzz_h, gen_helper_sve_sel_zpzz_s,
...
static gen_helper_gvec_reduc *const saddv_fns[4] = { gen_helper_sve_saddv_b, gen_helper_sve_saddv_h, gen_helper_sve_saddv_s,
                                                     NULL };
...
#define DO_ZPZW(NAME, name)                                                                                                \
    static gen_helper_gvec_4 *const name##_zpzw_fns[4] = { gen_helper_sve_##name##_zpzw_b, gen_helper_sve_##name##_zpzw_h, \
...
TRANS_FEAT_NONSTREAMING(FEXPA, aa64_sve, gen_gvec_ool_zz, fexpa_fns[a->esz], a->rd, a->rn, 0)
...
TRANS_FEAT_NONSTREAMING(FTSSEL, aa64_sve, gen_gvec_ool_arg_zzz, ftssel_fns[a->esz], a, 0)
...
static bool trans_SEL_pppp(DisasContext *s, arg_rprr_s *a)
{
    ...
    if(sve_access_check(s)) {
        unsigned psz = pred_gvec_reg_size(s);
        tcg_gen_gvec_bitsel(MO_8, pred_full_reg_offset(s, a->rd), pred_full_reg_offset(s, a->pg), pred_full_reg_offset(s, a->rn),
...
static bool trans_SINCDEC_v(DisasContext *s, arg_incdec2_cnt *a)
{
    ...
    if(inc != 0) {
        if(sve_access_check(s)) {
            do_sat_addsub_vec(s, a->esz, a->rd, a->rn, tcg_constant_i64(inc), a->u, a->d);
        }
    } else {
        do_mov_z(s, a->rd, a->rn);
    }
...
static bool trans_CPY_z_i(DisasContext *s, arg_CPY_z_i *a)
{
    ...
    if(sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2i_ool(vec_full_reg_offset(s, a->rd), pred_full_reg_offset(s, a->pg), tcg_constant_i64(a->imm), vsz, vsz, 0,
                            fns[a->esz]);
    }
    return true;
}
...
static bool trans_UNPK(DisasContext *s, arg_UNPK *a)
{
    ...
    if(sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2_ool(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn) + (a->h ? vsz / 2 : 0), vsz, vsz, 0,
                           fns[a->esz][a->u]);
    }
    return true;
}
...
TRANS_FEAT(ZIP1_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_zip_q, a, 0)
TRANS_FEAT(ZIP2_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_zip_q, a, ALIGN_DOWN(vec_full_reg_size(s), 32) / 2)
...
TRANS_FEAT(UZP1_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_uzp_q, a, 0)
TRANS_FEAT(UZP2_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_uzp_q, a, 16)
...
TRANS_FEAT(TRN1_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_trn_q, a, 0)
TRANS_FEAT(TRN2_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_trn_q, a, 16)
...
TRANS_FEAT(SPLICE_sve2, aa64_sve2, gen_gvec_ool_zzzp, gen_helper_sve_splice, a->rd, a->rn, (a->rn + 1) % 32, a->pg, a->esz)
...
#define DO_PPZW(NAME, name)                                                                                                      \
    static gen_helper_gvec_flags_4 *const name##_ppzw_fns[4] = { gen_helper_sve_##name##_ppzw_b, gen_helper_sve_##name##_ppzw_h, \
...
static bool trans_WHILE(DisasContext *s, arg_WHILE *a)
{
    ...
    if(a->lt ? !dc_isar_feature(aa64_sve, s) : !dc_isar_feature(aa64_sve2, s)) {
        return false;
    }
    if(!sve_access_check(s)) {
        return true;
...
static bool trans_SUBR_zzi(DisasContext *s, arg_rri_esz *a)
{
    ...
    if(sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2s(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), vsz, vsz, tcg_constant_i64(a->imm),
                        &op[a->esz]);
    }
    return true;
}
...
{
    if(sve_access_check(s)) {
        do_sat_addsub_vec(s, a->esz, a->rd, a->rn, tcg_constant_i64(a->imm), u, d);
    }
    return true;
}
...
static bool do_zzi_ool(DisasContext *s, arg_rri_esz *a, gen_helper_gvec_2i *fn)
{
    if(sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2i_ool(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), tcg_constant_i64(a->imm), vsz, vsz, 0,
                            fn);
    }
    return true;
}
...
TRANS_FEAT(SDOT_zzxw_s, aa64_sve, gen_gvec_ool_arg_zzxz, gen_helper_gvec_sdot_idx_b, a)
TRANS_FEAT(SDOT_zzxw_d, aa64_sve, gen_gvec_ool_arg_zzxz, gen_helper_gvec_sdot_idx_h, a)
TRANS_FEAT(UDOT_zzxw_s, aa64_sve, gen_gvec_ool_arg_zzxz, gen_helper_gvec_udot_idx_b, a)
TRANS_FEAT(UDOT_zzxw_d, aa64_sve, gen_gvec_ool_arg_zzxz, gen_helper_gvec_udot_idx_h, a)

TRANS_FEAT(SUDOT_zzxw_s, aa64_sve_i8mm, gen_gvec_ool_arg_zzxz, gen_helper_gvec_sudot_idx_b, a)
TRANS_FEAT(USDOT_zzxw_s, aa64_sve_i8mm, gen_gvec_ool_arg_zzxz, gen_helper_gvec_usdot_idx_b, a)
...
static bool do_FMLA_zzxz(DisasContext *s, arg_rrxr_esz *a, bool sub)
{
    ...
    return gen_gvec_fpst_zzzz(s, fns[a->esz], a->rd, a->rn, a->rm, a->ra, (a->index << 1) | sub,
...
static bool do_ppz_fp(DisasContext *s, arg_rpr_esz *a, gen_helper_gvec_3_ptr *fn)
{
    ...
    if(sve_access_check(s)) {
        ...
        tcg_gen_gvec_3_ptr(pred_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), pred_full_reg_offset(s, a->pg), status,
                           vsz, vsz, 0, fn);
        tcg_temp_free_ptr(status);
    }
    return true;
...
TRANS_FEAT_NONSTREAMING(FTMAD, aa64_sve, gen_gvec_fpst_zzz, ftmad_fns[a->esz], a->rd, a->rn, a->rm, a->imm,
                        a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)
...
static void do_fp_scalar(DisasContext *s, int zd, int zn, int pg, bool is_fp16, TCGv_i64 scalar, gen_helper_sve_fp2scalar *fn)
{
    unsigned vsz = vec_full_reg_size(s);
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static bool do_fp_imm(DisasContext *s, arg_rpri_esz *a, uint64_t imm, gen_helper_sve_fp2scalar *fn)
{
    if(fn == NULL) {
        return false;
    }
    if(sve_access_check(s)) {
        do_fp_scalar(s, a->rd, a->rn, a->pg, a->esz == MO_16, tcg_constant_i64(imm), fn);
    }
    return true;
}

#define DO_FP_IMM(NAME, name, const0, const1)                                                                            \
    static gen_helper_sve_fp2scalar *const name##_fns[4] = { NULL, gen_helper_sve_##name##_h, gen_helper_sve_##name##_s, \
                                                             gen_helper_sve_##name##_d };                                \
...
TRANS_FEAT(FCADD, aa64_sve, gen_gvec_fpst_zzzp, fcadd_fns[a->esz], a->rd, a->rn, a->rm, a->pg, a->rot,
           a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)

#define DO_FMLA(NAME, name)                                                                                           \
    static gen_helper_gvec_5_ptr *const name##_fns[4] = { NULL, gen_helper_sve_##name##_h, gen_helper_sve_##name##_s, \
                                                          gen_helper_sve_##name##_d };                                \
    TRANS_FEAT(NAME, aa64_sve, gen_gvec_fpst_zzzzp, name##_fns[a->esz], a->rd, a->rn, a->rm, a->ra, a->pg, 0,         \
               a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)
...
TRANS_FEAT(FCMLA_zpzzz, aa64_sve, gen_gvec_fpst_zzzzp, fcmla_fns[a->esz], a->rd, a->rn, a->rm, a->ra, a->pg, a->rot,
           a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)

static gen_helper_gvec_4_ptr *const fcmla_idx_fns[4] = { NULL, gen_helper_gvec_fcmlah_idx, gen_helper_gvec_fcmlas_idx, NULL };
TRANS_FEAT(FCMLA_zzxz, aa64_sve, gen_gvec_fpst_zzzz, fcmla_idx_fns[a->esz], a->rd, a->rn, a->rm, a->ra, a->index * 4 + a->rot,
           a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)
...
TRANS_FEAT(FCVT_sh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_sh, a, 0, FPST_FPCR)
TRANS_FEAT(FCVT_hs, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_hs, a, 0, FPST_FPCR)

TRANS_FEAT(BFCVT, aa64_sve_bf16, gen_gvec_fpst_arg_zpz, gen_helper_sve_bfcvt, a, 0, FPST_FPCR)

TRANS_FEAT(FCVT_dh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_dh, a, 0, FPST_FPCR)
TRANS_FEAT(FCVT_hd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_hd, a, 0, FPST_FPCR)
TRANS_FEAT(FCVT_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_ds, a, 0, FPST_FPCR)
TRANS_FEAT(FCVT_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_sd, a, 0, FPST_FPCR)

TRANS_FEAT(FCVTZS_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_hh, a, 0, FPST_FPCR_F16)
TRANS_FEAT(FCVTZU_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_hh, a, 0, FPST_FPCR_F16)
TRANS_FEAT(FCVTZS_hs, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_hs, a, 0, FPST_FPCR_F16)
TRANS_FEAT(FCVTZU_hs, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_hs, a, 0, FPST_FPCR_F16)
TRANS_FEAT(FCVTZS_hd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_hd, a, 0, FPST_FPCR_F16)
TRANS_FEAT(FCVTZU_hd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_hd, a, 0, FPST_FPCR_F16)

TRANS_FEAT(FCVTZS_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_ss, a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZU_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_ss, a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZS_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_sd, a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZU_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_sd, a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZS_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_ds, a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZU_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_ds, a, 0, FPST_FPCR)

TRANS_FEAT(FCVTZS_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_dd, a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZU_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_dd, a, 0, FPST_FPCR)

static gen_helper_gvec_3_ptr *const frint_fns[] = { NULL, gen_helper_sve_frint_h, gen_helper_sve_frint_s,
                                                    gen_helper_sve_frint_d };
TRANS_FEAT(FRINTI, aa64_sve, gen_gvec_fpst_arg_zpz, frint_fns[a->esz], a, 0, a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)

static gen_helper_gvec_3_ptr *const frintx_fns[] = { NULL, gen_helper_sve_frintx_h, gen_helper_sve_frintx_s,
                                                     gen_helper_sve_frintx_d };
TRANS_FEAT(FRINTX, aa64_sve, gen_gvec_fpst_arg_zpz, frintx_fns[a->esz], a, 0, a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR);

static bool do_frint_mode(DisasContext *s, arg_rpr_esz *a, int mode, gen_helper_gvec_3_ptr *fn)
{
    unsigned vsz;
    TCGv_i32 tmode;
    TCGv_ptr status;
    ...
    tcg_gen_gvec_3_ptr(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), pred_full_reg_offset(s, a->pg), status, vsz,
                       vsz, 0, fn);
...
TRANS_FEAT(FRINTN, aa64_sve, do_frint_mode, a, float_round_nearest_even, frint_fns[a->esz])
TRANS_FEAT(FRINTP, aa64_sve, do_frint_mode, a, float_round_up, frint_fns[a->esz])
TRANS_FEAT(FRINTM, aa64_sve, do_frint_mode, a, float_round_down, frint_fns[a->esz])
TRANS_FEAT(FRINTZ, aa64_sve, do_frint_mode, a, float_round_to_zero, frint_fns[a->esz])
TRANS_FEAT(FRINTA, aa64_sve, do_frint_mode, a, float_round_ties_away, frint_fns[a->esz])
...
TRANS_FEAT(FRECPX, aa64_sve, gen_gvec_fpst_arg_zpz, frecpx_fns[a->esz], a, 0, a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)
...
TRANS_FEAT(FSQRT, aa64_sve, gen_gvec_fpst_arg_zpz, fsqrt_fns[a->esz], a, 0, a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)

TRANS_FEAT(SCVTF_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_hh, a, 0, FPST_FPCR_F16)
TRANS_FEAT(SCVTF_sh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_sh, a, 0, FPST_FPCR_F16)
TRANS_FEAT(SCVTF_dh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_dh, a, 0, FPST_FPCR_F16)

TRANS_FEAT(SCVTF_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_ss, a, 0, FPST_FPCR)
TRANS_FEAT(SCVTF_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_ds, a, 0, FPST_FPCR)

TRANS_FEAT(SCVTF_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_sd, a, 0, FPST_FPCR)
TRANS_FEAT(SCVTF_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_dd, a, 0, FPST_FPCR)

TRANS_FEAT(UCVTF_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_hh, a, 0, FPST_FPCR_F16)
TRANS_FEAT(UCVTF_sh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_sh, a, 0, FPST_FPCR_F16)
TRANS_FEAT(UCVTF_dh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_dh, a, 0, FPST_FPCR_F16)

TRANS_FEAT(UCVTF_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_ss, a, 0, FPST_FPCR)
TRANS_FEAT(UCVTF_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_ds, a, 0, FPST_FPCR)
TRANS_FEAT(UCVTF_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_sd, a, 0, FPST_FPCR)

TRANS_FEAT(UCVTF_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_dd, a, 0, FPST_FPCR)
...
void gen_sve_ldr(DisasContext *s, TCGv_ptr base, int vofs, int len, int rn, int imm)
{
    ...
    if(len_remain) {
        ...
        switch(len_remain) {
            ...
            case 4:
            case 8:
                tcg_gen_qemu_ld_i64(t0, clean_addr, midx, MO_LE | ctz32(len_remain));
                break;
...
void gen_sve_str(DisasContext *s, TCGv_ptr base, int vofs, int len, int rn, int imm)
{
    int len_align = ALIGN_DOWN(len, 8);
    int len_remain = len % 8;
    int nparts = len / 8 + ctpop8(len_remain);
    ...
    if(len_remain) {
        ...
        switch(len_remain) {
            ...
            case 4:
            case 8:
                tcg_gen_qemu_st_i64(t0, clean_addr, midx, MO_LE | ctz32(len_remain));
                break;
...
static const MemOp dtype_mop[16] = { MO_UB, MO_UB, MO_UB, MO_UB, MO_SL, MO_UW, MO_UW, MO_UW,
                                     MO_SW, MO_SW, MO_UL, MO_UL, MO_SB, MO_SB, MO_SB, MO_UQ };

#define dtype_msz(x) (dtype_mop[x] & MO_SIZE)

/* The vector element size of dtype.  */
static const uint8_t dtype_esz[16] = { 0, 1, 2, 3, 3, 1, 2, 3, 3, 2, 2, 3, 3, 2, 1, 3 };

static void do_mem_zpa(DisasContext *s, int zt, int pg, TCGv_i64 addr, int dtype, uint32_t mte_n, bool is_write,
...
static gen_helper_gvec_mem *const ldr_fns[2][2][16][4] = {
    { /* mte inactive, little-endian */
      { { gen_helper_sve_ld1bb_r, gen_helper_sve_ld2bb_r, gen_helper_sve_ld3bb_r, gen_helper_sve_ld4bb_r },
        ...
        { gen_helper_sve_ld1hh_le_r, gen_helper_sve_ld2hh_le_r, gen_helper_sve_ld3hh_le_r, gen_helper_sve_ld4hh_le_r },
        { gen_helper_sve_ld1hsu_le_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1hdu_le_r, NULL, NULL, NULL },

        { gen_helper_sve_ld1hds_le_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1hss_le_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1ss_le_r, gen_helper_sve_ld2ss_le_r, gen_helper_sve_ld3ss_le_r, gen_helper_sve_ld4ss_le_r },
        { gen_helper_sve_ld1sdu_le_r, NULL, NULL, NULL },

        { gen_helper_sve_ld1bds_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1bss_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1bhs_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1dd_le_r, gen_helper_sve_ld2dd_le_r, gen_helper_sve_ld3dd_le_r, gen_helper_sve_ld4dd_le_r } },
     ...
     /* mte inactive, big-endian */
      { { gen_helper_sve_ld1bb_r, gen_helper_sve_ld2bb_r, gen_helper_sve_ld3bb_r, gen_helper_sve_ld4bb_r },
        ...
        { gen_helper_sve_ld1hh_be_r, gen_helper_sve_ld2hh_be_r, gen_helper_sve_ld3hh_be_r, gen_helper_sve_ld4hh_be_r },
        { gen_helper_sve_ld1hsu_be_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1hdu_be_r, NULL, NULL, NULL },

        { gen_helper_sve_ld1hds_be_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1hss_be_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1ss_be_r, gen_helper_sve_ld2ss_be_r, gen_helper_sve_ld3ss_be_r, gen_helper_sve_ld4ss_be_r },
        { gen_helper_sve_ld1sdu_be_r, NULL, NULL, NULL },

        { gen_helper_sve_ld1bds_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1bss_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1bhs_r, NULL, NULL, NULL },
        { gen_helper_sve_ld1dd_be_r, gen_helper_sve_ld2dd_be_r, gen_helper_sve_ld3dd_be_r, gen_helper_sve_ld4dd_be_r } } },

    { /* mte active, little-endian */
      { { gen_helper_sve_ld1bb_r_mte, gen_helper_sve_ld2bb_r_mte, gen_helper_sve_ld3bb_r_mte, gen_helper_sve_ld4bb_r_mte },
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void do_ld_zpa(DisasContext *s, int zt, int pg, TCGv_i64 addr, int dtype, int nreg)
{
    ...
    static gen_helper_gvec_mem *const fns[2][2][16] = {
        { /* mte inactive, little-endian */
          { gen_helper_sve_ldff1bb_r, gen_helper_sve_ldff1bhu_r, gen_helper_sve_ldff1bsu_r, gen_helper_sve_ldff1bdu_r,
            ...
            gen_helper_sve_ldff1sds_le_r, gen_helper_sve_ldff1hh_le_r, gen_helper_sve_ldff1hsu_le_r, gen_helper_sve_ldff1hdu_le_r,

            gen_helper_sve_ldff1hds_le_r, gen_helper_sve_ldff1hss_le_r, gen_helper_sve_ldff1ss_le_r, gen_helper_sve_ldff1sdu_le_r,

            gen_helper_sve_ldff1bds_r, gen_helper_sve_ldff1bss_r, gen_helper_sve_ldff1bhs_r, gen_helper_sve_ldff1dd_le_r },

         /* mte inactive, big-endian */
          { gen_helper_sve_ldff1bb_r, gen_helper_sve_ldff1bhu_r, gen_helper_sve_ldff1bsu_r, gen_helper_sve_ldff1bdu_r,

            gen_helper_sve_ldff1sds_be_r, gen_helper_sve_ldff1hh_be_r, gen_helper_sve_ldff1hsu_be_r, gen_helper_sve_ldff1hdu_be_r,

            gen_helper_sve_ldff1hds_be_r, gen_helper_sve_ldff1hss_be_r, gen_helper_sve_ldff1ss_be_r, gen_helper_sve_ldff1sdu_be_r,
        ...
        { /* mte active, little-endian */
          { gen_helper_sve_ldff1bb_r_mte, gen_helper_sve_ldff1bhu_r_mte, gen_helper_sve_ldff1bsu_r_mte,
            ...
            gen_helper_sve_ldff1sds_le_r_mte, gen_helper_sve_ldff1hh_le_r_mte, gen_helper_sve_ldff1hsu_le_r_mte,
            gen_helper_sve_ldff1hdu_le_r_mte,

            gen_helper_sve_ldff1hds_le_r_mte, gen_helper_sve_ldff1hss_le_r_mte, gen_helper_sve_ldff1ss_le_r_mte,
         ...
         /* mte active, big-endian */
          { gen_helper_sve_ldff1bb_r_mte, gen_helper_sve_ldff1bhu_r_mte, gen_helper_sve_ldff1bsu_r_mte,
            ...
            gen_helper_sve_ldff1sds_be_r_mte, gen_helper_sve_ldff1hh_be_r_mte, gen_helper_sve_ldff1hsu_be_r_mte,
            gen_helper_sve_ldff1hdu_be_r_mte,

            gen_helper_sve_ldff1hds_be_r_mte, gen_helper_sve_ldff1hss_be_r_mte, gen_helper_sve_ldff1ss_be_r_mte,
    ...
    static gen_helper_gvec_mem *const fns[2][2][16] = {
        { /* mte inactive, little-endian */
          { gen_helper_sve_ldnf1bb_r, gen_helper_sve_ldnf1bhu_r, gen_helper_sve_ldnf1bsu_r, gen_helper_sve_ldnf1bdu_r,
            ...
            gen_helper_sve_ldnf1sds_le_r, gen_helper_sve_ldnf1hh_le_r, gen_helper_sve_ldnf1hsu_le_r, gen_helper_sve_ldnf1hdu_le_r,

            gen_helper_sve_ldnf1hds_le_r, gen_helper_sve_ldnf1hss_le_r, gen_helper_sve_ldnf1ss_le_r, gen_helper_sve_ldnf1sdu_le_r,
         ...
         /* mte inactive, big-endian */
          { gen_helper_sve_ldnf1bb_r, gen_helper_sve_ldnf1bhu_r, gen_helper_sve_ldnf1bsu_r, gen_helper_sve_ldnf1bdu_r,
            ...
            gen_helper_sve_ldnf1sds_be_r, gen_helper_sve_ldnf1hh_be_r, gen_helper_sve_ldnf1hsu_be_r, gen_helper_sve_ldnf1hdu_be_r,

            gen_helper_sve_ldnf1hds_be_r, gen_helper_sve_ldnf1hss_be_r, gen_helper_sve_ldnf1ss_be_r, gen_helper_sve_ldnf1sdu_be_r,
        ...
        { /* mte inactive, little-endian */
          { gen_helper_sve_ldnf1bb_r_mte, gen_helper_sve_ldnf1bhu_r_mte, gen_helper_sve_ldnf1bsu_r_mte,
            ...
            gen_helper_sve_ldnf1sds_le_r_mte, gen_helper_sve_ldnf1hh_le_r_mte, gen_helper_sve_ldnf1hsu_le_r_mte,
            gen_helper_sve_ldnf1hdu_le_r_mte,

            gen_helper_sve_ldnf1hds_le_r_mte, gen_helper_sve_ldnf1hss_le_r_mte, gen_helper_sve_ldnf1ss_le_r_mte,
         ...
         /* mte inactive, big-endian */
          { gen_helper_sve_ldnf1bb_r_mte, gen_helper_sve_ldnf1bhu_r_mte, gen_helper_sve_ldnf1bsu_r_mte,
            ...
            gen_helper_sve_ldnf1sds_be_r_mte, gen_helper_sve_ldnf1hh_be_r_mte, gen_helper_sve_ldnf1hsu_be_r_mte,
            gen_helper_sve_ldnf1hdu_be_r_mte,

            gen_helper_sve_ldnf1hds_be_r_mte, gen_helper_sve_ldnf1hss_be_r_mte, gen_helper_sve_ldnf1ss_be_r_mte,
...
static bool trans_LD1R_zpri(DisasContext *s, arg_rpri_load *a)
{
    ...
    tcg_gen_qemu_ld_i64(temp, clean_addr, get_mem_index(s), finalize_memop(s, dtype_mop[a->dtype]));
...
static void do_st_zpa(DisasContext *s, int zt, int pg, TCGv_i64 addr, int msz, int esz, int nreg)
{
    static gen_helper_gvec_mem *const fn_single[2][2][4][4] = {
        { { { gen_helper_sve_st1bb_r, gen_helper_sve_st1bh_r, gen_helper_sve_st1bs_r, gen_helper_sve_st1bd_r },
            ...
            { NULL, NULL, gen_helper_sve_st1ss_le_r, gen_helper_sve_st1sd_le_r },
         ...
         { { gen_helper_sve_st1bb_r, gen_helper_sve_st1bh_r, gen_helper_sve_st1bs_r, gen_helper_sve_st1bd_r },
            ...
            { NULL, NULL, gen_helper_sve_st1ss_be_r, gen_helper_sve_st1sd_be_r },
            { NULL, NULL, NULL, gen_helper_sve_st1dd_be_r } }     },

        { { { gen_helper_sve_st1bb_r_mte, gen_helper_sve_st1bh_r_mte, gen_helper_sve_st1bs_r_mte, gen_helper_sve_st1bd_r_mte },
            { NULL, gen_helper_sve_st1hh_le_r_mte, gen_helper_sve_st1hs_le_r_mte, gen_helper_sve_st1hd_le_r_mte },
            { NULL, NULL, gen_helper_sve_st1ss_le_r_mte, gen_helper_sve_st1sd_le_r_mte },
         ...
         { { gen_helper_sve_st1bb_r_mte, gen_helper_sve_st1bh_r_mte, gen_helper_sve_st1bs_r_mte, gen_helper_sve_st1bd_r_mte },
            ...
            { NULL, NULL, gen_helper_sve_st1ss_be_r_mte, gen_helper_sve_st1sd_be_r_mte },
...
TRANS_FEAT(SQDMULH_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, sqdmulh_zzz_fns[a->esz], a, 0)
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_sshll_vec(unsigned vece, TCGv_vec d, TCGv_vec n, int64_t imm)
{
    int top = imm & 1;
    int shl = imm >> 1;
    int halfbits = 4 << vece;
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_ushll16_i64(TCGv_i64 d, TCGv_i64 n, int64_t imm)
{
    gen_ushll_i64(MO_16, d, n, imm);
}

//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_ushll32_i64(TCGv_i64 d, TCGv_i64 n, int64_t imm)
{
    gen_ushll_i64(MO_32, d, n, imm);
}

//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_ushll64_i64(TCGv_i64 d, TCGv_i64 n, int64_t imm)
{
    gen_ushll_i64(MO_64, d, n, imm);
}

//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_ushll_vec(unsigned vece, TCGv_vec d, TCGv_vec n, int64_t imm)
{
    int halfbits = 4 << vece;
    int top = imm & 1;
    int shl = imm >> 1;
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static bool do_shll_tb(DisasContext *s, arg_rri_esz *a, const GVecGen2i ops[3], bool sel)
{
...
static const GVecGen2i ushll_ops[3] = {
    { .fni8 = gen_ushll16_i64, .fniv = gen_ushll_vec, .opt_opc = ushll_list, .fno = gen_helper_sve2_ushll_h, .vece = MO_16 },
    { .fni8 = gen_ushll32_i64, .fniv = gen_ushll_vec, .opt_opc = ushll_list, .fno = gen_helper_sve2_ushll_s, .vece = MO_32 },
    { .fni8 = gen_ushll64_i64, .fniv = gen_ushll_vec, .opt_opc = ushll_list, .fno = gen_helper_sve2_ushll_d, .vece = MO_64 },
};
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static bool do_narrow_extract(DisasContext *s, arg_rri_esz *a, const GVecGen2 ops[3])
{
...
static const GVecGen2 sqxtunt_ops[3] = {
    { .fniv = gen_sqxtunt_vec, .opt_opc = sqxtun_list, .load_dest = true, .fno = gen_helper_sve2_sqxtunt_h, .vece = MO_16 },
    { .fniv = gen_sqxtunt_vec, .opt_opc = sqxtun_list, .load_dest = true, .fno = gen_helper_sve2_sqxtunt_s, .vece = MO_32 },
    { .fniv = gen_sqxtunt_vec, .opt_opc = sqxtun_list, .load_dest = true, .fno = gen_helper_sve2_sqxtunt_d, .vece = MO_64 },
};
...
static const GVecGen2i shrnb_ops[3] = {
    { .fni8 = gen_shrnb16_i64, .fniv = gen_shrnb_vec, .opt_opc = shrnb_vec_list, .fno = gen_helper_sve2_shrnb_h, .vece = MO_16 },
    { .fni8 = gen_shrnb32_i64, .fniv = gen_shrnb_vec, .opt_opc = shrnb_vec_list, .fno = gen_helper_sve2_shrnb_s, .vece = MO_32 },
    { .fni8 = gen_shrnb64_i64, .fniv = gen_shrnb_vec, .opt_opc = shrnb_vec_list, .fno = gen_helper_sve2_shrnb_d, .vece = MO_64 },
};
...
static const TCGOpcode sqshrunt_vec_list[] = { INDEX_op_shli_vec, INDEX_op_sari_vec, INDEX_op_smax_vec, INDEX_op_umin_vec, 0 };
...
static const TCGOpcode sqshrnt_vec_list[] = { INDEX_op_shli_vec, INDEX_op_sari_vec, INDEX_op_smax_vec, INDEX_op_smin_vec, 0 };
static const GVecGen2i sqshrnt_ops[3] = {
    { .fniv = gen_sqshrnt_vec, .opt_opc = sqshrnt_vec_list, .load_dest = true, .fno = gen_helper_sve2_sqshrnt_h, .vece = MO_16 },
    { .fniv = gen_sqshrnt_vec, .opt_opc = sqshrnt_vec_list, .load_dest = true, .fno = gen_helper_sve2_sqshrnt_s, .vece = MO_32 },
    { .fniv = gen_sqshrnt_vec, .opt_opc = sqshrnt_vec_list, .load_dest = true, .fno = gen_helper_sve2_sqshrnt_d, .vece = MO_64 },
};
...
static const GVecGen2i uqshrnt_ops[3] = {
    { .fniv = gen_uqshrnt_vec, .opt_opc = uqshrnt_vec_list, .load_dest = true, .fno = gen_helper_sve2_uqshrnt_h, .vece = MO_16 },
    { .fniv = gen_uqshrnt_vec, .opt_opc = uqshrnt_vec_list, .load_dest = true, .fno = gen_helper_sve2_uqshrnt_s, .vece = MO_32 },
    { .fniv = gen_uqshrnt_vec, .opt_opc = uqshrnt_vec_list, .load_dest = true, .fno = gen_helper_sve2_uqshrnt_d, .vece = MO_64 },
};
...
static gen_helper_gvec_flags_4 *const match_fns[4] = { gen_helper_sve2_match_ppzz_b, gen_helper_sve2_match_ppzz_h, NULL, NULL };
TRANS_FEAT_NONSTREAMING(MATCH, aa64_sve2, do_ppzz_flags, a, match_fns[a->esz])

static gen_helper_gvec_flags_4 *const nmatch_fns[4] = { gen_helper_sve2_nmatch_ppzz_b, gen_helper_sve2_nmatch_ppzz_h, NULL,
                                                        NULL };
...
TRANS_FEAT_NONSTREAMING(FMMLA_s, aa64_sve_f32mm, gen_gvec_fpst_zzzz, gen_helper_fmmla_s, a->rd, a->rn, a->rm, a->ra, 0, FPST_FPCR)
TRANS_FEAT_NONSTREAMING(FMMLA_d, aa64_sve_f64mm, gen_gvec_fpst_zzzz, gen_helper_fmmla_d, a->rd, a->rn, a->rm, a->ra, 0, FPST_FPCR)
...
TRANS_FEAT(USDOT_zzzz, aa64_sve_i8mm, gen_gvec_ool_arg_zzzz, a->esz == 2 ? gen_helper_gvec_usdot_b : NULL, a, 0)

TRANS_FEAT_NONSTREAMING(AESMC, aa64_sve2_aes, gen_gvec_ool_zz, gen_helper_crypto_aesmc, a->rd, a->rd, a->decrypt)

TRANS_FEAT_NONSTREAMING(AESE, aa64_sve2_aes, gen_gvec_ool_arg_zzz, gen_helper_crypto_aese, a, false)
TRANS_FEAT_NONSTREAMING(AESD, aa64_sve2_aes, gen_gvec_ool_arg_zzz, gen_helper_crypto_aese, a, true)
...
TRANS_FEAT(FCVTNT_sh, aa64_sve2, gen_gvec_fpst_arg_zpz, gen_helper_sve2_fcvtnt_sh, a, 0, FPST_FPCR)
TRANS_FEAT(FCVTNT_ds, aa64_sve2, gen_gvec_fpst_arg_zpz, gen_helper_sve2_fcvtnt_ds, a, 0, FPST_FPCR)

TRANS_FEAT(BFCVTNT, aa64_sve_bf16, gen_gvec_fpst_arg_zpz, gen_helper_sve_bfcvtnt, a, 0, FPST_FPCR)

TRANS_FEAT(FCVTLT_hs, aa64_sve2, gen_gvec_fpst_arg_zpz, gen_helper_sve2_fcvtlt_hs, a, 0, FPST_FPCR)
TRANS_FEAT(FCVTLT_sd, aa64_sve2, gen_gvec_fpst_arg_zpz, gen_helper_sve2_fcvtlt_sd, a, 0, FPST_FPCR)

TRANS_FEAT(FCVTX_ds, aa64_sve2, do_frint_mode, a, float_round_to_odd, gen_helper_sve_fcvt_ds)
TRANS_FEAT(FCVTXNT_ds, aa64_sve2, do_frint_mode, a, float_round_to_odd, gen_helper_sve2_fcvtnt_ds)

static gen_helper_gvec_3_ptr *const flogb_fns[] = { NULL, gen_helper_flogb_h, gen_helper_flogb_s, gen_helper_flogb_d };
TRANS_FEAT(FLOGB, aa64_sve2, gen_gvec_fpst_arg_zpz, flogb_fns[a->esz], a, 0, a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)

static bool do_FMLAL_zzzw(DisasContext *s, arg_rrrr_esz *a, bool sub, bool sel)
{
    return gen_gvec_ptr_zzzz(s, gen_helper_sve2_fmlal_zzzw_s, a->rd, a->rn, a->rm, a->ra, (sel << 1) | sub, cpu_env);
}
...
{
    return gen_gvec_ptr_zzzz(s, gen_helper_sve2_fmlal_zzxw_s, a->rd, a->rn, a->rm, a->ra, (a->index << 2) | (sel << 1) | sub,
                             cpu_env);
}
...
TRANS_FEAT(BFDOT_zzzz, aa64_sve_bf16, gen_gvec_ool_arg_zzzz, gen_helper_gvec_bfdot, a, 0)
TRANS_FEAT(BFDOT_zzxz, aa64_sve_bf16, gen_gvec_ool_arg_zzxz, gen_helper_gvec_bfdot_idx, a)

TRANS_FEAT_NONSTREAMING(BFMMLA, aa64_sve_bf16, gen_gvec_ool_arg_zzzz, gen_helper_gvec_bfmmla, a, 0)

static bool do_BFMLAL_zzzw(DisasContext *s, arg_rrrr_esz *a, bool sel)
{
    return gen_gvec_fpst_zzzz(s, gen_helper_gvec_bfmlal, a->rd, a->rn, a->rm, a->ra, sel, FPST_FPCR);
}
...
{
    return gen_gvec_fpst_zzzz(s, gen_helper_gvec_bfmlal_idx, a->rd, a->rn, a->rm, a->ra, (a->index << 1) | sel, FPST_FPCR);
}
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_sclamp_i32(TCGv_i32 d, TCGv_i32 n, TCGv_i32 m, TCGv_i32 a)
{
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_sclamp_i64(TCGv_i64 d, TCGv_i64 n, TCGv_i64 m, TCGv_i64 a)
{
...
//  TODO: Remove the attribute after restoring code using the function.
__attribute__((unused)) static void gen_sclamp_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m, TCGv_vec a)
{
...
static void gen_sclamp(unsigned vece, uint32_t d, uint32_t n, uint32_t m, uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
    ...
    static const GVecGen4 ops[4] = {
        ...
        { .fni4 = gen_sclamp_i32, .fniv = gen_sclamp_vec, .fno = gen_helper_gvec_sclamp_s, .opt_opc = vecop, .vece = MO_32 },
        { .fni8 = gen_sclamp_i64,
         .fniv = gen_sclamp_vec,
...
static void gen_uclamp(unsigned vece, uint32_t d, uint32_t n, uint32_t m, uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
    ...
    static const GVecGen4 ops[4] = {
        ...
        { .fni4 = gen_uclamp_i32, .fniv = gen_uclamp_vec, .fno = gen_helper_gvec_uclamp_s, .opt_opc = vecop, .vece = MO_32 },
        { .fni8 = gen_uclamp_i64,
         .fniv = gen_uclamp_vec,
